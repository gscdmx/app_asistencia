...
class Asistencias_miercolesExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
          return  DB::table('tb_asistencias_miercoles')->select("tb_asistencias_miercoles.id","cat_delegaciones.delegacion","cat_coord_territorials.ct2","cat_coord_territorials.sector","tb_asistencias_miercoles.se_realizo","tb_asistencias_miercoles.no_motivo","tb_asistencias_miercoles.fecha","tb_asistencias_miercoles.hora_i","tb_asistencias_miercoles.hora_f","tb_asistencias_miercoles.jg","tb_asistencias_miercoles.mp","tb_asistencias_miercoles.jsp","tb_asistencias_miercoles.jspi","tb_asistencias_miercoles.jc","tb_asistencias_miercoles.ml","tb_asistencias_miercoles.otro","tb_asistencias_miercoles.representante_alcaldia","tb_asistencias_miercoles.ins","tb_asistencias_miercoles.vecino","tb_asistencias_miercoles.archivo_imagen","tb_asistencias_miercoles.calle","tb_asistencias_miercoles.created_at","tb_asistencias_miercoles.updated_at")
