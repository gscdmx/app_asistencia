      ...
      <div class="side-navbar-wrapper">
        ...
        <!-- Sidebar Navigation Menus-->
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">  
            ...
            <li><a href="{{url('/preguntas')}}"> <i class="icon-list"></i>RED DE CONTACTO CIUDADANO</a></li>
            <li><a href="{{url('/getlistadopreguntas')}}"> <i class="icon-list"></i>VER MI RED DE CONTACTO CIUDADANO</a></li>
            ...
            <li><a href="{{url('/reporte_fecha')}}"> <i class="icon-list"></i>Reporte Asistencia Diario GM</a></li>
             ...
             <li><a href="{{url('/adminpdfView')}}"> <i class="icon-list"></i>Administrador de PDF´S</a></li>
              ...
              <li><a href="{{url('/usuariopdfView')}}"> <i class="icon-list"></i>Usuario PDF</a></li>
               <?php endif?>
...
Dudas y comentarios, enviar un mensaje via TELEGRAM al siguiente grupo: <a href="{{url('https://t.me/joinchat/AAAAAFHI8FMMsNwLycJy8g')}}">  (darle click y en automático te redirigirá al canal).<br>
