...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-horizontal" method="POST" action="<?php echo e(url('/guardarEdicionUsuario').'/'.$datos_usuario->id); ?>">
      ...
      <?php endif; ?>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
           <input type="text" class="form-control" id="user" name="user" value="<?php echo e($datos_usuario->name); ?>">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
           <input type="text" class="form-control" id="email" name="email" value="<?php echo e($datos_usuario->email); ?>">
            <!--<textarea id="motivo" name="motivo" class="form-control" ></textarea>-->
                                     ...
                                     <tbody>
                                      ...
                                      <tr>
                                       ...
                                       <td><?php echo e($permiso->permiso); ?></td>
                                         ...
                                         <td>
                                          <?php $__currentLoopData = $permisos_actuales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso_actual): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <?php if($permiso_actual==$permiso->id): ?> 
                                          ...
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                           <input class="checkBoxClass" name="permisos[]" value="<?php echo e($permiso->id); ?>" type="checkbox" <?php echo $selected;?>  >
