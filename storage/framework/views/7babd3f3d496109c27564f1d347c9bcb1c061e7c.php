...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-horizontal" method="POST" action="<?php echo e(url('/guardar_asistencia_admin_miercoles')); ?>">
      ...
      <?php endif; ?>
         ...
         <div class="form-group row">
          <label class="col-sm-2 form-control-label">Selecciona Usuario:</label>
     ...
     <div  style="display:none;" id="show_descripcion">
        ...
        <div class="line"></div>
        <div class="form-group row">
          <label class="col-sm-2 form-control-label">Describe el Motivo:</label>
          <div class="col-sm-10">
            <!--<input type="text" class="form-control">-->
        ...
        <div class="form-group row">
          ...
          <label class="col-sm-2 form-control-label">Reunión con JG</label>
          <div class="col-sm-10 mb-3">
