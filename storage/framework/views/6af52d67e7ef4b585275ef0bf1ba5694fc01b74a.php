...
Los mapas de red vecinal e incidencia delictiva con su respectiva descripción.<br><br>
               ...
               <!-- <h4>Metodologías</h4>-->
                <li><a href="<?php echo e(url('/uploads/GSCYPJ/mapasred.pdf')); ?>"><i class="icon-list"></i>RED VECINAL</a></li><br>
                <li><a href="<?php echo e(url('/uploads/GSCYPJ/mapascrimen.pdf')); ?>"><i class="icon-list"></i>ANÁLISIS DELICTIVO</a></li><br>
             <!-- <H4>Mapas.</H1><br>-->
     ...
     <?php if(Auth::user()->name==$cor->ct2): ?>
      <div class=“row”>
         ...
         <div class="col-sm-6 ">
             <a class="btn btn-primary" href="<?php echo e(url('/uploads/GSCYPJ').'/'.$cor->ct2.'_2019-01-012019-08-04.html'); ?>" role="button"> MAPA -ANÁLISIS DELICTIVO <?php echo e($cor->ct2); ?></a><br><br>
         </div>
