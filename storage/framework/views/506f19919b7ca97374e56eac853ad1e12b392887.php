...
<div class="col-lg-12">
  <div class="card">
    ...
    <div class="card-body">
      <form class="form-horizontal" method="POST" action="<?php echo e(url('/guardar_cuestionario_Entrevistas')); ?>">
     ...
     <div class="line"></div>
           <div class="form-group row">
             ...
             <?php if($errors->has('mp_visitado')): ?> <p  style="color: red"><?php echo e($errors->first('mp_visitado')); ?></p> <?php endif; ?> 
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 mb-3">
            <select name="cuantos" id="cuantos" class="form-control" required>
             ...
             <?php if($errors->has('cuantos')): ?> <p  style="color: red"><?php echo e($errors->first('cuantos')); ?></p> <?php endif; ?> 
          </div>
         ...
         <div class="line"></div>
          ...
          <div class="col-sm-9 mb-3">
            <input type="text" class="form-control" id="tiempo" name="tiempo"   required></input>
               ...
               <?php if($errors->has('tiempo')): ?> <p  style="color: red"><?php echo e($errors->first('tiempo')); ?></p> <?php endif; ?> 
                  </div>
          ...
          <div class="line"></div>
           <div class="form-group row">
             ...
             <?php if($errors->has('desalentando_policia')): ?> <p  style="color: red"><?php echo e($errors->first('desalentando_policia')); ?></p> <?php endif; ?> 
          </div>
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-9 mb-3">
            <select name="desalentado_servidor" id="desalentado_servidor" class="form-control" required>
             ...
             <?php if($errors->has('desalentado_servidor')): ?> <p  style="color: red"><?php echo e($errors->first('desalentado_servidor')); ?></p> <?php endif; ?> 
          </div>
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-9 mb-3">
            <select name="trato" id="trato" class="form-control" required>
             ...
             <?php if($errors->has('trato')): ?> <p  style="color: red"><?php echo e($errors->first('trato')); ?></p> <?php endif; ?> 
          </div>
